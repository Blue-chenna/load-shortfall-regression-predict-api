...
#Extracting numeric data and transforming the datatype
    ...
    #Converting our time feature to datetime series
    feature_vector_df["time"] = pd.to_datetime(feature_vector_df["time"])

    #Extracting the Day, Month and hour from our time column and Inserting it into our Dataframe
    feature_vector_df["Month"] = feature_vector_df["time"].dt.month
    feature_vector_df.insert(2, "Month", feature_vector_df.pop("Month"))

    feature_vector_df["Day"] = feature_vector_df["time"].dt.day
    feature_vector_df.insert(3, "Day", feature_vector_df.pop("Day"))

    feature_vector_df["Hour"] = feature_vector_df["time"].dt.hour
    feature_vector_df.insert(4, "Hour", feature_vector_df.pop("Hour"))

    predict_vector = feature_vector_df[['Month', 'Day', 'Hour', 'Madrid_wind_speed', 'Valencia_wind_deg',
       ...
       'Madrid_temp', 'Madrid_temp_min', 'load_shortfall_3h', 'Hour']]
    # ------------------------------------------------------------------------
